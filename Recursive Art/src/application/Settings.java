...
public class Settings {
	...
	// just some artificial strength value that matches our needs.
	private ObjectProperty<Vector2D> forceGravity = new SimpleObjectProperty<>( new Vector2D(0,.05)); 	 
	...
	// emitter
	// -------------------------------
	private IntegerProperty emitterFrequency = new SimpleIntegerProperty(1); // particles per frame
	...
	private DoubleProperty particleMaxSpeed = new SimpleDoubleProperty( 8);
